...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> Skinship@gmail.com</li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Address:Burgos St ,Mangatarem ,Pangasinan </li>
                            <li>Phone: 09457309541</li>
                            <li>Email: skinship@gmail.com</li>
                        </ul>
                    </div>
                </div>
